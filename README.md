...
In order to run app, just make sure that you have Docker in your computer and clone this repo. Then ` docker-compose up -d --build`. The app is already on `localhost:8501`
